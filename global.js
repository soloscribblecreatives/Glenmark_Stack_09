...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/Board.png" width="1024" height="768"></div><div class="button1" onclick="playVid1()"></div><div class="video1"><video onended="myFunction()" id="startVideo" width="1024" height="768"><source src="slide2/Spin1.mp4" type="video/mp4"></video></div><div class="button2" onclick="playVid2()"><img src="slide2/Restore.png"></div><div class="video2"><video onended="myFunction1()" id="midVideo" width="1024" height="768"><source src="slide2/Spin2.mp4" type="video/mp4"></video></div><div class="button3" onclick="playVid3()"><img src="slide2/Restore.png"></div><div class="video3"><video onended="myFunction2()" id="endVideo" width="1024" height="768"><source src="slide2/Spin3.mp4" type="video/mp4"></video></div><audio id="success" src="slide2/Success.mp3" type="audio/mpeg"></audio><div class="success" onclick="brand()"><img src="slide2/Success.png" width="1024" height="768"></div><div class="brand"><img src="slide2/Brand.png" width="1024" height="768"></div>';
	break;
    case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/Board.png" width="1024" height="768"></div><div class="button1" onclick="playVid1()"></div><div class="video1"><video onended="myFunction()" id="startVideo" width="1024" height="768"><source src="slide3/Spin1.mp4" type="video/mp4"></video></div><div class="button2" onclick="playVid2()"><img src="slide3/Restore.png"></div><div class="video2"><video onended="myFunction1()" id="midVideo" width="1024" height="768"><source src="slide3/Spin2.mp4" type="video/mp4"></video></div><div class="button3" onclick="playVid3()"><img src="slide3/Restore.png"></div><div class="video3"><video onended="myFunction2()" id="endVideo" width="1024" height="768"><source src="slide3/Spin3.mp4" type="video/mp4"></video></div><audio id="success" src="slide3/Success.mp3" type="audio/mpeg"></audio><div class="success" onclick="brand()"><img src="slide3/Success.png" width="1024" height="768"></div><div class="brand"><img src="slide3/Brand.png" width="1024" height="768"></div>';
	break;
	case 4:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide4.css" media="screen"/><div class="background"><img src="slide4/Board.png" width="1024" height="768"></div><div class="button1" onclick="playVid1()"></div><div class="video1"><video onended="myFunction()" id="startVideo" width="1024" height="768"><source src="slide4/Spin1.mp4" type="video/mp4"></video></div><div class="button2" onclick="playVid2()"><img src="slide4/Restore.png"></div><div class="video2"><video onended="myFunction1()" id="midVideo" width="1024" height="768"><source src="slide4/Spin2.mp4" type="video/mp4"></video></div><div class="button3" onclick="playVid3()"><img src="slide4/Restore.png"></div><div class="video3"><video onended="myFunction2()" id="endVideo" width="1024" height="768"><source src="slide4/Spin3.mp4" type="video/mp4"></video></div><audio id="success" src="slide4/Success.mp3" type="audio/mpeg"></audio><div class="success" onclick="brand()"><img src="slide4/Success.png" width="1024" height="768"></div><div class="brand"><img src="slide4/Brand.png" width="1024" height="768"></div>';
	break;
}
